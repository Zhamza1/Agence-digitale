    ...
    <section className=' bg-header2 lg:bg-header1024 sm:bg-header425  2xl:pb-[8rem]  pb-[6rem] text-white w-full rounded-bl-[80px] sm:rounded-bl-[80px] lg:pb-[4rem]'>
      ...
      <div  >
        ...
        <div className='pt-[3rem] text-center sm:mb-[3rem]' >
          <Link to="/contact" > <button type='submit' className=' text-[#FE6965] bg-main font-medium px-[4rem] py-[0.5rem] rounded-full hover:bg-[#EFEFEF] transition ease-in-out delay-100 text-[2rem] md:text-[16px]  dark:text-[#FE6965] dark:bg-slate-800 ' >Contact</button> </Link> 
