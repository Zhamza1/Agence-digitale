...
const Home = (name,picto,pictoH3,pictoP,alt,css) => {
  ...
  return (
    ...
    <section >
      ...
      <div className='bg-spaceBetween-2560 xl:bg-spaceBetween sm:bg-spaceBetween-425 w-[100%] md:h-[56rem] sm:h-[75rem] mini:h-[90rem] rounded-tr-[10rem] sm:rounded-tr-[90px] rounded-bl-[10rem] sm:rounded-bl-[90px]  ' >
